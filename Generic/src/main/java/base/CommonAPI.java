...
public class CommonAPI {
    ...
    /* public WebDriver driver = null;
     ...
     public void setUp(String url) throws Exception {
         System.setProperty("webdriver.chrome.driver", "/Users/ahmadkarim/Desktop/projects/MavenProjects/Group_Project/Generic/Driver/chromedriver");
         driver = new ChromeDriver();
 ...
 */
    ...
    public void typeByCssEnter(String locator) {
        driver.findElement(By.cssSelector(locator)).sendKeys(Keys.ENTER);
    }

    public void typeByCssAnyKeys(String locator, String value) {
    ...
    public List<WebElement> getListOfWebElementaByCss(String locator) {
        List<WebElement> list = new ArrayList<WebElement>();
    ...
    public List<String> GetListOfStringFromWebElement(List<WebElement> list) {
